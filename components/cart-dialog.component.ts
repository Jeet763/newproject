  ...
  template: `
    ...
    <div  *ngIf="cartItems && cartItems.length > 0">
      ...
      <div class="cart-total">
       ...
       <p><button type="button" class="btn btn-outline-dark btn-sm" (click)="emptyCart()">Empty Cart</button></p>
       <button routerLink="/cart" class="btn btn-outline-dark btn-sm">Cart</button>
       <button routerLink="/checkout" class="btn btn-outline-dark btn-sm">Checkout</button>
       </div>
    <div  *ngIf="cartItems && !(cartItems.length > 0)">
