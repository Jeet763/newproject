...
<div class="container">
   <i><h3 style="float: left;text-align: left;">Customize Your Ride using our Top featured products!</h3></i>
   <div class="col-12 text-right m-4">
     <a class="btn btn-light prev" data-target="#postsCarousel" data-slide="prev" title="go back"><i class="fa fa-lg fa-chevron-left"></i></a>
        <a class="btn btn-light next" data-target="#postsCarousel" data-slide="next" title="more"><i class="fa fa-lg fa-chevron-right"></i></a>
   </div>
     ...
     <div class="container p-t-0 m-t-2 carousel-inner">
       <div class="row row-equal carousel-item active m-t-0">
           <div class="col-md-4" *ngFor='let product of products | slice:0:3;let i = index;'>
             <div class="card">
               <img [src]="product.image" alt="parts" style="width:100%">
               <h1>{{product.name}}</h1>
...
<div class="container">
   ...
   <div class="col-12 text-right m-4">
     <a class="btn btn-light prev" data-target="#postsCarousel1" data-slide="prev" title="go back"><i class="fa fa-lg fa-chevron-left"></i></a>
        <a class="btn btn-light next" data-target="#postsCarousel1" data-slide="next" title="more"><i class="fa fa-lg fa-chevron-right"></i></a>
   </div>
   <div class="dropdown-divider"></div>
   </div>
     <div class="container p-t-0 m-t-2 carousel-inner">
